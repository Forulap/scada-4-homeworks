...
AVEVA Wonderware — лидер по разработке программного обеспечения для промышленности. Одним из наиболее известных ПО для разработки SCADA-проектов является AVEVA Edge. Этот программный продукт позволит понять особенности проектирования SCADA-систем в целом и порядок работы с крупнейшим программным продуктом фирмы AVEVA.

В результате выполнения задания вы:

* разработаете собственный SCADA-проект в среде AVEVA Edge и проверите его работу;
* научитесь работать с программными элементами и компонентами AVEVA Edge.
...
1. Разработка проекта автоматизации сбора данных с электронных счётчиков. 
1. Разработка проекта автоматизации сбора данных со станков ЧПУ.
1. Разработка проекта автоматизации распределения запасных частей на складе.
...
Результат выполнения задания — проект, разработанный в программной среде AVEVA Edge по выбранному техническому заданию.
