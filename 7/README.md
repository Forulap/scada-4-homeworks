...
●	Соответствие ТЗ (полнота реализации требований к функционалу и графическому интерфейсу).

●	Корректность расчетов параметров.

●	Качество графического интерфейса (необходимые элементы интерактивны, корректность отображения вводимых и выводимых значений).
